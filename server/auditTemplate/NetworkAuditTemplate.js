...
const { networkAuditFrontPage, webDisclaimer, tableOfContent_web, documentControl, introduction, scope, term_defination_legends, toolsAndReferences, executiveSummary, assessmentMethodology } = require('../json/auditJSON');
...
`
    ...
    <div class="">
        <table class="table table-bordered mt-4" style="border-color:black;">
            <tbody>
                <tr  class="bg-sky-blue" >
                    <td colspan="2" class="content_table_white vulnerability_dynamic_table_heading fw-bold">8.1 ${reportData.ReportDetails.AuditDetails[0].Title}</td>
                </tr>
                <tr>
                    <td class="content_table_white align-middle fw-bold" width="15%">Risk Level</td>
                    <td class="content_table_white align-middle text-dark fw-normal ${reportData.ReportDetails.AuditDetails[0].Severity === "Informational" ? "bg-info" : reportData.ReportDetails.AuditDetails[0].Severity === "Critical" ? "bg-critical" : reportData.ReportDetails.AuditDetails[0].Severity === "High" ? "bg-danger" : reportData.ReportDetails.AuditDetails[0].Severity === "Medium" ? "bg-warning" : "bg-success"}">${reportData.ReportDetails.AuditDetails[0].Severity}</td>
                </tr>
                <tr>
                    <td class="content_table_white align-middle" colspan="2"><strong class="fw-bold">Description : </strong>  ${reportData.ReportDetails.AuditDetails[0].Description}</td>
                </tr>
                <tr>
                    <td class="content_table_white align-middle" colspan="2"><strong class="fw-bold">Impact : </strong>  ${reportData.ReportDetails.AuditDetails[0].Impact}</td>
                </tr>
                <tr>
                    <td class="content_table_white align-middle" colspan="2"><strong class="fw-bold">Remediation : </strong>  ${reportData.ReportDetails.AuditDetails[0].Remediation}</td>
                </tr>
                <tr>
                    <td class="content_table_white align-middle" colspan="2"><strong class="fw-bold">Affects : </strong>   ${reportData.ReportDetails.AuditDetails[0].Affects}
                    </td>
                </tr>
                <tr>
                    <td class="content_table_white align-middle fw-bold">Status</td>
                    <td class="content_table_white align-middle fw-normal ${reportData.ReportDetails.AuditDetails[0].Status === "Open" ? "text-danger" : reportData.ReportDetails.AuditDetails[0].Status === "Closed" ? "text-success" : "text-dark"} " >${reportData.ReportDetails.AuditDetails[0].Status}</td>
                </tr>
            </tbody>
        </table>
